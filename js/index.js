...
var animator = new Animator(animationContainer);
...
let poem = [
    ...
    { text: "有人说浪漫是山花海树", style: "fade" },
    { text: "相望不相近", style: "slide" },
    { text: "但彼此倒映美好", style: "roll" },
    { text: "有人说浪漫是落霞孤鹜", style: "peel" },
    { text: "梦着远方,眼中也有远方", style: "converge" },
    { text: "有人说浪漫是初心懵懂", style: "spiral" },
    { text: "一眼的回望", style: "meteorite" },
    { text: "就占据了青春的时光", style: "slide" },
    { text: "我说浪漫是少年的心", style: "peel" },
    { text: "风一吹就草长莺飞，山河烂漫", style: "swivel" },
    { text: "怀抱着初心,捡起了梦想", style: "meteorite" },
    { text: "跌跌撞撞奔向了未来", style: "bounce" },
    { text: "浪漫至死不渝", style: "bubble" },
    { text: "致程序员", style: "float" },
]



function randomEffect(effect) {
    return effect[parseInt(Math.random() * effect.length)]
}

function initSubtitles(data, startTime) {
    data.forEach(item => {
        setTimeout(() => {
            animationContainer.innerHTML = item.text;
            animationContainer.style.display = 'none'
            new FunkyLetters(animationContainer, { colorize: true });
            animator = new Animator(animationContainer);
            animationContainer.style.display = 'block'
            animator.animate(item.style);
        }, startTime);
        startTime += 5000
    })
}

initSubtitles(poem, 1000);
